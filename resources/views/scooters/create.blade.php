...
<div class="container mt-4">
    ...
    <div class="row">
        <div class="col-md-8">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('scooters.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                            <button type="submit" class="btn btn-primary">
                                <i class="fas fa-save"></i> {{ __('messages.save_scooter') }}
                            </button>
                        </div>
                    </form>
                </div>
        ...
        <div class="col-md-4">
            <div class="card">
                ...
                <div class="card-body">
                    <p>{{ __('messages.scooter_create_info') }}</p>
                    <ul>
                        <li>{{ __('messages.all_fields_required') }}</li>
                        <li>{{ __('messages.image_optional') }}</li>
